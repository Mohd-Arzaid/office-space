import { ChevronDown, Phone, User, ArrowRight } from "lucide-react";
    ...
    <section className="pt-8 pb-12 px-6 ">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-roboto font-bold mb-2">Find Properties in These Cities</h2>
          <p className="text-gray-600 font-roboto text-lg">Discover your perfect stay in the most exciting and vibrant cities around the world.</p>
        </div>
            ...
            >
              <div className="aspect-[4/5] relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <h3 className="text-2xl font-roboto font-bold mb-2">{city.name}</h3>
                  <p className="text-gray-200 font-roboto mb-3">{city.description}</p>
                  <div className="flex items-center gap-2">
                    <span className="text-[#E7C873] font-bold">{city.properties}</span>
...
const WhyWorkWithUsSection = () => {
  ...
  return (
    <section className="pt-12 pb-16 px-6 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-roboto font-bold mb-1">Why You Should Work With Us</h2>
          <p className="text-gray-600 font-roboto">Join hands with a team that values innovation, collaboration, and your growth together</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-roboto font-bold mb-4 text-gray-800">{feature.title}</h3>
              <p className="text-gray-600 font-roboto leading-relaxed text-lg">{feature.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mt-24 relative">
          ...
          <div className="relative bg-[#1B4B40] rounded-3xl p-16 text-white text-center transform -rotate-1 hover:rotate-0 transition-transform duration-500">
            <h3 className="text-3xl font-roboto font-bold mb-6">Sign in to streamline your search</h3>
    ...
    <section className="pt-14 pb-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-roboto font-bold mb-1">Featured Properties</h2>
          <p className="text-gray-600 font-roboto">Discover the best properties in the market with the best prices and the best locations.</p>
        </div>

        {/* Filter Buttons */}
        <div className="flex justify-center gap-4 mb-12">
          {["All Properties", "Villa", "Apartments", "Office"].map((filter, index) => (
            <button
              key={index}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {properties.map((property) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-xl font-roboto font-bold mb-2">{property.title}</h3>
                ...
                {/* Price */}
                <div className="text-xl font-bold text-[#1B4B40]">{property.price}</div>
              </div>
            </div>
          ))}
        </div>
    ...
    <section className="relative h-[600px] flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl px-6">
        ...
        <p className="text-lg font-roboto text-gray-200 mb-8 max-w-lg mx-auto">
          Pellentesque egestas egestas faucibus sem. Velit nunc egestas ut morbi. Leo diam diam egestas ut morbi.
        </p>
          ...
          <div className="grid grid-cols-2 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="space-y-2">
                <div className="text-3xl font-bold text-[#1B4B40]">{stat.value}</div>
                <div className="text-gray-600 font-roboto text-sm leading-tight">{stat.label}</div>
              </div>
            ))}
          </div>
  ...
  const testimonials = [
    {
      ...
      content: "Searches for multiplexes, property comparisons, and the loan estimator. Works great. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dores."
    },
    {
      id: 2,
      ...
      content: "The platform is incredibly user-friendly and efficient. The property comparison tool saved me hours of work. Highly recommend for any real estate professional."
    }
  ];
                ...
                >
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="font-roboto text-gray-400">{testimonial.role}</p>
                    </div>
